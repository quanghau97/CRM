                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    <c:forEach var="data" items="${listJob}">
                                        <tr>
                                            <td>${data.id}</td>
                                            <td>${data.name}</td>
                                            ...
                                            <td>${data.endDate}</td>
                                            <td>
                                               <a href="/helloservlet/groupwork-update?id=${data.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="#" id-job=${data.id} class="btn btn-sm btn-danger btn-xoa">Xóa</a>
                                                <a href="/helloservlet/groupwork-details?id=${data.id}" class="btn btn-sm btn-info">Xem</a>
                                            </td>
                                        </tr>
                                     </c:forEach>
