			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							 <form action="/helloservlet/task-update" method="post" class="form-horizontal form-material">
								<div class="form-group">
									<label class="col-md-12">Dự án</label>
									<div class="col-md-12">
										<select name="jobId" class="form-control form-control-line">
                                        <c:forEach  var="data" items="${job}"> 
>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="task-name" placeholder="Tên công việc"
...
>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="task-starDay" placeholder="dd/MM/yyyy"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="task-endDay" placeholder="dd/MM/yyyy"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
                                        ...
                                        <c:forEach  var="data" items="${status}"> 
>
                                        <option value="${data.id}">${data.name}</option>
                                        </c:forEach>
